...
<div class="animated_bkg">

		<img src="<?php the_field('immagine_1'); ?>" />

		<img src="<?php the_field('immagine_2'); ?>" />

		<img src="<?php the_field('immagine_3'); ?>" />

		<img src="<?php the_field('immagine_4'); ?>" />
